...
subtitle1 = "For the past two-hundred years people have debated over the definitive ranking of American lakes. Here's why Lake Mead deserves the top spot."
subtitle2 = "Everyone has been in one. But no one understands inflatable rafts like I do and what I know can change your life."
...
story_1 = { title: "Is Lake Mead the best lake?", body: body, author_id: 2, image_url: "https://upload.wikimedia.org/wikipedia/commons/2/23/Lake_mapourika_NZ.jpeg", subtitle: subtitle1}
Story.create(story_1)

body2 = "Lake Mead is the largest reservoir in the United States, measured by water capacity. It is on the Colorado River about 24 mi (39 km) from the Las Vegas Strip southeast of the city of Las Vegas, Nevada, in the states of Nevada and Arizona. Formed by the Hoover Dam, Lake Mead is 112 miles (180 km) long when the lake is full, has 759 miles (1,221 km) of shoreline, is 532 feet (162 m) at greatest depth, with a surface elevation of 1,221.4 feet (372.3 m) above sea level, and has 247 square miles (640 km2) of surface, and when filled to available capacity, 26.12 million acre feet (32.22 km3) of water. The lake has not reached full capacity, however, since 1983 due to a combination of drought and increased water demand.[1][2][3] Owing to current low water level, Lake Sakakawea holds claim over Lake Mead in terms of the United State's largest reservoir by total area and water in reserve."

story_2 = { title: "Ten great things to do with an inflatable raft at Lake Mead this summer", body: body2, author_id: 2, image_url: "http://www.boatstogo.com/images/detailed/1/inflatable-raft-RD290N-02.JPG", subtitle: subtitle2 }
